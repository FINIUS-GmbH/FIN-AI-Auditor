    ...
    return [
        ChatMessage(
            ...
            content=(
                ...
                "Die einzige Ausnahme sind explizit bestaetigte User-Wahrheiten; sie uebersteuern alle anderen Quellen "
                "und muessen danach in allen betroffenen Doku- und Code-Stellen gespiegelt werden. "
                ...
                "Fuer das intendierte Zielbild gilt primaer: die Mehrheit der Dokumentquellen "
                "(Confluence, lokale Architektur-/Vertragsdoku, Metamodell) beschreibt, wie der BSM-Prozess gedacht ist. "
                "Code ist primaer Ist-Zustand und Implementierungsbeleg, nicht automatisch die Zieldefinition. "
                ...
                "Nutze Code anschließend, um zu bewerten, ob dieser dokumentierte Zielzustand bereits vollstaendig "
                "und widerspruchsfrei umgesetzt ist oder ob Doku- bzw. Implementierungsbausteine fehlen.\n\n"
