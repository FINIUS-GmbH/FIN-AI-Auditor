...
def _build_enriched_messages(
    *,
    ...
    user_prompt = (
        ...
        "2. 'recommendation': Formuliere KONKRETE Aenderungsanweisungen — NICHT abstrakt.\n"
        "   SCHLECHT: 'Dokumentation konsolidieren und Write-Contract haerten.'\n"
        "   GUT: 'Auf der Confluence-Seite \"BSM Datenmodell\" im Abschnitt \"Statement\" steht \"write_path: /api/v2/statements\", "
        "aber die aktuelle Implementierung nutzt \"/api/v3/statements\". "
        "Die Confluence-Seite muss auf /api/v3/statements aktualisiert werden.'\n"
        "   Nenne IMMER: welche Datei/Seite, welcher Abschnitt, was dort aktuell steht, was dort stehen muss.\n"
        ...
        "6. AENDERUNGSLISTE: Fuer jede Empfehlung muss erkennbar sein:\n"
        "   - WO: Exakte Datei, Confluence-Seite oder Abschnitt\n"
        "   - WAS: Was dort aktuell steht (Ist-Zustand)\n"
        "   - SOLL: Was dort stehen muss (Soll-Zustand)\n"
        "   Wenn die genaue Stelle nicht identifizierbar ist, erklaere WARUM und was geprueft werden muss.\n\n"
